...
import (
	...
	pbAuth "cinema/api-gateway/proto/auth"
	pbMovie "cinema/api-gateway/proto/movie"
	pbPayment "cinema/api-gateway/proto/payment"
...
func NewGateway(movieAddr, authAddr, paymentAddr string) (*Gateway, error) {
	movieConn, err := grpc.Dial(movieAddr, grpc.WithTransportCredentials(insecure.NewCredentials()))
	if err != nil {
		return nil, err
	}
